    ...
    <el-form ref="formRef" label-width="120px" :model="form" :rules="rules">
      ...
      <el-row>
        ...
        <el-col :span="12">
          ...
          >
            <el-date-picker
              v-model="form.actualSettlementDate"
              :style="{ width: '100%' }"
              type="date"
            />
          </el-form-item>
  ...
  export default defineComponent({
    ...
    setup(props, { emit }) {
      ...
      const state = reactive({
        ...
        form: {
          isQualified: 1,
          dealWithDynamic: 'ProblemFBStatus4',
        },
        rules: {
          pt_ID: [
          ...
          //   { required: true, trigger: 'blur', message: '请选择实际完成时间' },
          // ],
          causeAnalysis: [
          ...
          planEndTime: [
            { required: true, trigger: 'blur', message: '请选择计划完成时间' },
          ],
          reasonType: [
        ...
        isHG2: false,
        disabledDate(time) {
          return time.getTime() <= new Date(state.form.estimatedSettlementDate)
        },
      })
      ...
      const showEdit = (row) => {
        ...
        if (state.form.isQualified == 0) {
          state.form.dealWithDynamic = 'ProblemFBStatus4'
          state.isHG = false
          state.isHG2 = true
        } else {
          state.isHG2 = false
