  ...
  <div class="system-configuration-container">
    <vab-query-form>
      <vab-query-form-left-panel :span="12">
        <el-button
          v-permissions="{ permission: ['devicestatus:add'] }"
          :icon="Plus"
          type="primary"
          @click="handleEdit"
        >
        ...
        <el-button
          v-permissions="{ permission: ['devicestatus:delete'] }"
          :icon="Delete"
          type="danger"
          @click="handleDelete"
        >
      ...
      <vab-query-form-right-panel :span="12">
        <el-form :inline="true" :model="queryForm" @submit.prevent>
          <!-- <el-form-item label="房间号码">
            <el-input
              v-model.trim="queryForm.roomNumber"
              clearable
              placeholder="请输入房间号码"
            />
          </el-form-item>
    ...
    >
      ...
      <el-table-column align="center" label="操作" width="180">
        <template #default="{ row }">
          <el-button
            v-permissions="{ permission: ['devicestatus:edit'] }"
            link
            type="primary"
...
<script>
  import { getList, doDelete } from '@/api/basics/devicestatus'
