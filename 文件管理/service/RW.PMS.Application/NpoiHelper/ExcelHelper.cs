...
namespace RW.PMS.Application.NpoiHelper
{
    public class ExcelHelper
    {
        ...
        public static MemoryStream ParseListToExcel<T>(IList<T> list, string sheetName = "sheet1", bool overwrite = true, bool xlsx = true) where T : class
        {
        ...
        public static List<T> ParseExcelToList<T>(Stream fileStream, string sheetname = "") where T : class
        {
            ...
            var mapper = new Npoi.Mapper.Mapper(fileStream);
