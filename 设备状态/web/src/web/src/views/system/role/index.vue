    ...
    <el-row :gutter="20">
      ...
      <el-col :lg="8" :md="8" :sm="24" :xl="9" :xs="24">
        <vab-card shadow="hover">
          ...
          <el-table v-loading="listLoading" border :data="list" highlight-current-row @row-click="setRowClick"
            @selection-change="setSelectRows">
            <el-table-column align="center" show-overflow-tooltip type="selection" />
            <el-table-column align="center" label="角色名" prop="role" show-overflow-tooltip />
      ...
      <el-col :lg="16" :md="16" :sm="24" :xl="15" :xs="24">
        <vab-card v-loading="saveLoading" body-style="{height:100%}" shadow="hover">
          <template #header>
            <div class="card-header">
              <div>权限</div>
              <div>
                <el-link type="primary" :underline="false" @click="savePermission">
                  保存
                </el-link>
