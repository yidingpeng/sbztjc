  ...
  <div class="dashboard-container">
    <el-row :gutter="20">
      <el-col :lg="6" :md="12" :sm="24" :xl="6" :xs="24">
        <top-card background="blue" :count-config="countConfig1" icon="money-cny-circle-line" percentage="10%"
          title="总销量" />
      </el-col>
      <el-col :lg="6" :md="12" :sm="24" :xl="6" :xs="24">
      ...
      <el-col :lg="6" :md="12" :sm="24" :xl="6" :xs="24">
        <top-card background="white" icon="user-search-line" percentage="30%" title="活跃用户" />
      </el-col>
      <el-col :lg="6" :md="12" :sm="24" :xl="6" :xs="24">
