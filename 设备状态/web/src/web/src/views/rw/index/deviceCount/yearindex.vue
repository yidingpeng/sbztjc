      ...
      <el-col :lg="24" :md="24" :sm="24" :xl="24" :xs="24">
        <vab-card shadow="hover">
          ...
          <el-table v-loading="listLoading" border :data="list" highlight-current-row @selection-change="setSelectRows"
            ...
            <el-table-column align="center" fixed label="试验台架" prop="roomName" show-overflow-tooltip width="220" />
            <el-table-column align="center" fixed label="设备" prop="deviceName" show-overflow-tooltip width="220" />
            <!-- <el-table-column align="center" fixed label="试验编号" prop="testNumber" show-overflow-tooltip width="120" /> -->
            <el-table-column align="center" label="运行时间" prop="totalRunTime" show-overflow-tooltip
              :formatter="formatEndTime" width="220" />
            <el-table-column align="center" label="停机时间" prop="totalStopTime" show-overflow-tooltip
              :formatter="formatEndTime" width="220" />
            <el-table-column align="center" label="故障时间" prop="totalFaultDownTime" show-overflow-tooltip
              :formatter="formatEndTime" width="220" />
            <el-table-column align="center" label="故障次数" prop="toalFaultNumber" show-overflow-tooltip width="220" />
            <el-table-column align="center" label="闲置时间" prop="totalFreeTime" show-overflow-tooltip
              :formatter="formatEndTime" width="220" />
            <el-table-column align="center" label="维保时间" prop="weibaoTime" show-overflow-tooltip fixed="right"
              :formatter="formatEndTime" width="220" />
...
import { getyear, importyearcount } from '@/api/DeviceStatus/DeviceDataCount'
...
export default defineComponent({
  ...
  setup() {
    ...
    const handleDownload = async () => {
      ...
      const data = await importyearcount(state.queryForm)
      ...
      link.setAttribute('download', `设备年统计${formattedDateTime}.xlsx`);
