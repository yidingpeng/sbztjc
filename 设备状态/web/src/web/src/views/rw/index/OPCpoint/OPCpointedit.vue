  ...
  <el-dialog v-model="dialogFormVisible" :title="title" width="500px" @close="close">
    <el-form ref="formRef" label-width="80px" :model="form" :rules="rules">
      <el-form-item label="标记名称" prop="tagName">
        <el-input v-model="form.tagName" show-word-limit />
      </el-form-item>
      <el-form-item label="地址" prop="address">
        <el-input v-model="form.address" show-word-limit />
      </el-form-item>
      <el-form-item label="说明" prop="explainInfo">
        <el-input v-model="form.explainInfo" show-word-limit />
      </el-form-item>
    </el-form>
    <template #footer>
...
import { doEdit, doAdd } from '@/api/DeviceStatus/OPCpoint'
