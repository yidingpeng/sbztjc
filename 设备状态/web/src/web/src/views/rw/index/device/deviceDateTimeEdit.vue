<template>
  <el-dialog v-model="dialogFormVisible" :title="title" width="500px" @close="close">
    <el-form ref="formRef" label-width="150px" :model="form" :rules="rules">
      ...
      <el-form-item label="培训时间" prop="trainningTime">
        <el-input v-model="form.trainningTime" :style="{ width: '100px' }" type="number" step="0.1" />小时
      </el-form-item>
...
import { doEdit } from '@/api/DeviceStatus/DeviceTimeInput'
