	    ...
	    value: function initPagination() {
	      ...
	      if (this.options.showJumpTo) {
	        ...
	        if (!$jumpTo.length) {
                ...
                //完善 page-jump-to 跳转插件等于负数问题
	            $jumpTo = $("\n          <div class=\"page-jump-to ".concat(this.constants.classes.inputGroup, "\">\n          <input onkeyup=\"this.value=this.value.replace(/\D/g,'')\" min=\"1\" type=\"number\" class=\"").concat(this.constants.classes.input).concat(Utils.sprintf(' input-%s', this.options.iconSize), "\" value=\"").concat(this.options.pageNumber, "\">\n          <button class=\"").concat(this.constants.buttonsClass, "\"  type=\"button\">\n          ").concat(this.options.formatJumpTo(), "\n          </button>\n          </div>\n        ")).appendTo($pageGroup);
