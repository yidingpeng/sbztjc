...
$(document).ready(function() { 
    $("#addBtn").bind("click", function(){ 
        $("<tr><td id='toolModels'></td><td id='toolCode'></td><td id='devPurchaseDate'></td><td id='devExpireDate'></td><td id='devremark'></td><td class='del-col'><a href='javascript:void(0);' class='delBtn'>删除</a></td></tr>").insertBefore(".append-row");
         trEdit();
		 delTr();
		$("tbody tr:odd").css("background-color","#EEEEEE");
    }); 
