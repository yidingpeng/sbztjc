//LHR 2020-05-05 修复关闭无限分页后，导致点击上一页和下一页改变了当前页码问题
//paginationLoop: false 设置为 true 启用分页条无限循环的功能。
//修复bootstrap-table设置了paginationLoop为false时点击上一页还是出发了页码++

//扩展跳转下一页功能 2020-05-05 目前已禁用，改为 bootstrap-table page-jump-to 插件
    ...
    var CONSTANTS = {
        ...
        4: {
            ...
            html: {
                ...
                dropdownCaret: '<span class="caret"></span>',
                //2020-05-05源代码
                pagination: ['<ul class="pagination%s">', '</ul><div class="goPage"><div class="input-group mb-5"></div>'],
                //扩展跳转下一页功能 2020-05-05 先降低高度
                //pagination: ['<ul class="pagination%s"  style="height:34px;">', '</ul>&nbsp;<input type="number" min="0"  id="pageNum" class="form-control" style="width:60px;">&nbsp;<button id="button3" class="btn btn-secondary" onclick="toPage();">跳转</button>'],
	...
	function () {
	    ...
	    _createClass(BootstrapTable, [{
	        ...
	        value: function onPagePre(event) {
	            ...
	            //LHR 2020-05-05 修复关闭无限分页，点击上一页改变了当前页码问题
	            //paginationLoop: false 设置为 true 启用分页条无限循环的功能。
	            //修复bootstrap-table设置了paginationLoop为false时点击上一页还是出发了页码++
	        ...
	        value: function onPageNext(event) {
	            ...
	            //LHR 2020-05-05 修复关闭无限分页，点击下一页改变了当前页码问题
	            //paginationLoop: false 设置为 true 启用分页条无限循环的功能。
	            //修复bootstrap-table设置了paginationLoop为false时点击下一页还是出发了页码++
	            //console.log(this.options.pageNumber);
	            if ($(event.target).hasClass("disabled")) {
	                return false;
	            }
