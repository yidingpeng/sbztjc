...
(function (factory) {
    ...
    */
    ...
    return {
        l: function (argm) {
            this.createNotification('l', argm)
        },
        log: function (argm) {
