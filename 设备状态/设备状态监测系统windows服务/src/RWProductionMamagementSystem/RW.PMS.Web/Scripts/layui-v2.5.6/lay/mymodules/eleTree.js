...
layui.define(["jquery","laytpl"], function (exports) {
    ...
    Class.prototype={
        ...
        render: function() {
            ...
            // load加载框
            //options.elem.append('<div class="eleTree-loadData"><i class="layui-icon layui-icon-loading layui-icon layui-anim layui-anim-rotate layui-anim-loop" style="margin-left:-30px;;font-size: 50px; color: #dc3545;"></i></div>')

            //修改load加载框样式 LHR 2020-05-21
            options.elem.append('<div class="eleTree-loadData"><i class="layui-icon layui-icon-loading layui-icon layui-anim layui-anim-rotate layui-anim-loop" style="margin-left:-30px;margin-top:-30px;font-size: 50px;color: #1E9FFF;"></i></div>')
        ...
        checkboxRender: function() {
            ...
            options.elem.find("input.eleTree-hideen[type=checkbox]").each(function(index,item){
                ...
                if($(item).attr("eletree-status")==="1"){
                    ...
                    //将子级部分选中父级checkbox样式换位 layui中的 -
                    checkbox.children("i").removeClass("layui-icon-ok").addClass("layui-icon-subtraction");
