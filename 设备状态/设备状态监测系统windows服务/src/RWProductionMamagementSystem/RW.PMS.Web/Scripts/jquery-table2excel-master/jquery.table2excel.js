        ...
        init: function () {
            ...
            e.template = {
                ...
                mid: "</x:ExcelWorksheets></x:ExcelWorkbook></xml><![endif]-->" +
                    "<style>" +
                    "td{border:0.5px: solid black;display:table-cell;vertical-align:middle;text-align:center;height:25px;font-size:14px;font-family:SimSun;} table{border:0.5px solid black;}" +
                    "</style>" +
                    "</head><body>",
                table: {
                    head: "<table>",
