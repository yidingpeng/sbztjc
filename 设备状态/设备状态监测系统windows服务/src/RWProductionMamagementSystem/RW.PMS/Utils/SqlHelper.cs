...
namespace RW.PMS.WinForm
{
    ...
    public sealed class SqlHelper
    {
        ...
        public static string GetConnectionString()
        {
            ...
            //SqlConnectionString conString = new SqlConnectionString(".", "CAAAPP", false, "sa", "asdjkl456");

            //strProvider = System.Configuration.ConfigurationManager.AppSettings["Provider"].ToString();
           // strConnection = System.Configuration.ConfigurationManager.ConnectionStrings["DatabaseConnString"].ToString();

            //return ConfigurationManager.ConnectionStrings["DatabaseConnString"].ConnectionString;


            //if (!dataUtil.ORM.IU_ORM_DBSetting.DBs.ContainsKey("main"))
            //{
            //    string strEncrypt = System.Configuration.ConfigurationManager.AppSettings["Encrypt"].ToString();
            //    string strconn = Encry.Decrypt(strEncrypt, "AdBcCbDa");
            //    dataUtil.ORM.IU_ORM_DBSetting.DBs.Add("main", dataUtil.DB.IU_DB_DataBase.Create(strconn, dataUtil.DB.DataDBType.SQL_SERVER));
            //}
               

            ////笔记本
            //string mylocalSQL = @"2RWi/geCgcDRAvO1LqxMGIgW0cXOrivZUPnp+ZQPRauGKAriwzUhZeeW9LaqCB2ir/kW8bdPtjhss9E5fJ6i6+Jynq44DJSH88r8GPQDXUH7SV9FPiQlENGAYYw3UeZ1tEreBbPJxYL/pUzbOFpYJZLvj3rGLoQoPRUGecCtiEbjbA0R/fqjYCB0WH5iBRVh";
            ////宁波服务器192.168.2.11
            //string NbServerSQL = @"2RWi/geCgcDUPHb6UoUIoIPWwTu8AsNKzSNebPCqcXIrvXFx7kGKhP1OB2gIOXM5gC/8VSYaQVG/GwzeEmuZ/4vvj6CgQ0DpyoUBPRLBDlSkY3rGuzOkSx9taZ3AdXyCn2u8uaeGfAMMaMr6GZdL5XjdF0Xw5OCfvUtkZLNX74jJkVkEGA1BfHQFuQKADx1Eza8T/IJ08URX8b3qNi85WQ==";
            ////公司本机
            //string localSQL = @"2RWi/geCgcDRAvO1LqxMGIgW0cXOrivZUPnp+ZQPRauGVYYV7G3dHthwZoi6sfD6k4qVl9aLhZwZ9nd4UZiHLModtZqUuBUME7KJYju5rbt73suv9PJDwTv7dqpBbB7CteebpEZcVvgnhP282SrIk0PfioRvhNZQTqg/tRovWmZ5mbjZeXFl/Q==";

            //string DelocalSQL = Encry.Decrypt(localSQL, "AdBcCbDa");
            //string DeNbServerSQL = Encry.Decrypt(NbServerSQL, "AdBcCbDa");
            //string DeMyLocalSQL = Encry.Decrypt(mylocalSQL, "AdBcCbDa");

            //return DeMyLocalSQL;


            string strEncrypt = System.Configuration.ConfigurationManager.ConnectionStrings["RWPMS_DBDataContext"].ToString();
            DecryptAndEncryptHelper decryptAndEncryptHelper=new DecryptAndEncryptHelper();

            string strconn = decryptAndEncryptHelper.Decrypto(strEncrypt);
        ...
        {
            return ExecuteNonQuery(SqlHelper.GetConnectionString(), commandType, commandText, (SqlParameter[])null);
        }
        public static int ExecuteNonQuery(string commandText, params SqlParameter[] commandParameters)
        {
            return ExecuteNonQuery(SqlHelper.GetConnectionString(), CommandType.Text, commandText, commandParameters);
        }
        /// <summary>   
        ...
        {
            return ExecuteNonQuery(SqlHelper.GetConnectionString(), commandType, commandText, commandParameters);
        }
        ...
        {
            return ExecuteDataset(SqlHelper.GetConnectionString(), commandType, commandText, (SqlParameter[])null);
        }
        ...
        {
            return ExecuteDataset(SqlHelper.GetConnectionString(), commandType, commandText, commandParameters);
        }
        ...
        {
            return ExecuteReader(SqlHelper.GetConnectionString(), commandType, commandText, (SqlParameter[])null);
        }
        /// <summary>
        ...
        {
            return ExecuteReader(SqlHelper.GetConnectionString(), commandType, commandText, commandParameters);
        }
        /// <summary>   
        /// 执行指定数据库连接字符串的数据阅读器,指定参数.   
        /// </summary>   
