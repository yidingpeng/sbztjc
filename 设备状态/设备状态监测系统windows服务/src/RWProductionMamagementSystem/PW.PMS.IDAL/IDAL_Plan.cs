...
{
    public interface IDAL_Plan : IDependence
    {
        #region 出勤模式
        ...
        int EditPlanDetailCompartNo(int ID, string strCompartNo);
        ...
        /// <returns></returns>
        List<BundleAnalysisPlanModel> GetPlanInfoByBundleAnalysis(string[] ppCode);
        ...
        /// <returns></returns>
        int SaveBundleAnalysisResults(List<BundleAnalysisPlanModel> BundleAnalysisPlanModel);
